...
- (void)viewDidLoad {
    ...
    NSLog(@"array data %@",self.myPreviousVCDict);
     ...
     self.buss_name_lbl.text=[self.myPreviousVCDict valueForKey:@"name"];
   
    self.address_lbl.text=[self.myPreviousVCDict valueForKey:@"address"];
    ...
    self.mem_lbl.text=[self.myPreviousVCDict valueForKey:@"member_since"];
   
    self.dec_lbl.text=[self.myPreviousVCDict valueForKey:@"des"];
