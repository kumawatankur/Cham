...
#import "creditcard_ViewController.h"
...
@interface creditcard_ViewController ()
@property(nonatomic, strong, readwrite) PayPalConfiguration *payPalConfig;

@end

@implementation creditcard_ViewController
...
- (IBAction)payment:(id)sender {
    ...
    PayPalItem *item1 = [PayPalItem itemWithName:@"Old jeans with holes"
                                    withQuantity:1
                                       withPrice:[NSDecimalNumber decimalNumberWithString:self.tx_payment.text]
                                    withCurrency:@"USD"
                                         withSku:@"Hip-00037"];
...
-(BOOL)isFormValid
{
    ...
    NSPredicate *emailTest =[NSPredicate predicateWithFormat:@"SELF MATCHES %@",emailRegEx];
     ...
     if([emailTest evaluateWithObject: _txemail.text]==NO)
    {
    ...
    else if (_txdes.text && _txdes.text.length==0)
    {
